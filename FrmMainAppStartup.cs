...
public partial class FrmMainApp
{
    ...
    /// </summary>
    private void AppStartupApplyObjectNames()
    {
        Logger.Debug(message: "Starting");
        ...
        try
        {
            ...
            foreach (DataRow dr in dt.Rows)
            {
                ...
                {
                    Logger.Error(message: "lvw_FileList is null");
                }
            }
    ...
    /// <summary>
    ///     Enables column sorting for the main listview
    /// </summary>
    private void AppStartupApplyColumnSorting()
    {
        // Create the sorter for the list view
        Logger.Debug(message: "Starting");

        LvwColumnSorter = new ListViewColumnSorter();
        lvw_FileList.ListViewItemSorter = LvwColumnSorter;
    }
