...
/// <summary>
///     The ISO 3166 country table: names, two- and three-letter codes.
/// </summary>
/// <remarks>
///     GeoNames answers with two-letter codes while the IPTC tags GeoTagNinja writes use the three-letter
///     form, so a local mapping is needed regardless of what the API returns.
/// </remarks>
