...
public partial class FrmSettings : Form
{
    ...
    private void AssignControlLabelsAndValues()
    {
        ...
        _lstTpgApplicationControls = ControlTraversal
                                    .GetAllControls(control: tpg_Application)
                                    .ToList();
        _lstTpgGeoNamesControls = ControlTraversal.GetAllControls(control: tpg_GeoNames)
                                                 .ToList();
            ...
            foreach (Control control in controls)
            {
                    ...
                    control == cbx_TryUseGeoNamesLanguage)
                {
                    ...
                    foreach (string alreadyTranslatedLanguage in languageList)
                    {
                        ...
                        native =
                            SessionDataTables.DataGetFirstOrDefaultFromDataTable(
                        ...
                        english = SessionDataTables.DataGetFirstOrDefaultFromDataTable(
                            dataTableIn: FrmMainApp.DTLanguageMapping,
                                  ...
                                  EventArgs e)
    {
        ...
        foreach (string ext in
                 SupportedFileExtensions.AllCompatibleExtensions())
        {
    ...
    private void LoadCustomRulesDGV()
    {
        ...
        foreach (string itemName in CustomRulesMetadata.CustomRulesDataSources())
        {
        ...
        // 03b fill dropdown
        // If (e.g.: "Is", "Contains")
        foreach (string itemName in CustomRulesMetadata.CustomRulesDataConditions())
        {
        ...
        foreach (SourcesAndAttributes.ElementAttribute itemName in
                 CustomRulesMetadata.CustomRulesDataTargets())
        {
        ...
        foreach (string itemName in CustomRulesMetadata.CustomRulesDataSources(isOutcome: true))
        {
    ...
    private void LoadCustomCityLogicDGV()
    {
        ...
        foreach (string itemName in CustomRulesMetadata.CustomCityLogicDataSources())
        {
                                      ...
                                      EventArgs e)
    {
                        ...
                        if ((cbx.Font.Style & FontStyle.Bold) != 0)
                        {
                            ...
                            else if (cbx == cbx_TryUseGeoNamesLanguage)
                            {
                                IEnumerable<KeyValuePair<string, string>> result =
                                    LanguageLists.GetISO_639_1_Languages()
                                       .Where(predicate: kvp =>
                                            kvp.Value ==
                                            cbx.Text);
        ...
        // refresh user data
        _ = AppStartup.AppStartupApplyDefaults(settingTabPage: "tpg_Application",
        ...
        _ = AppStartup.AppStartupReadCustomCityLogic();
        ...
        if (!_nowLoadingSettingsData)
        {
            ...
            switch (actualParentName)
            {
                ...
                case "gbx_MapColourMode":
                    ...
                    IEnumerable<Control> controls = ControlTraversal.GetAllControls(control: gbx_MapColourMode);
                    foreach (Control control in controls)
                    {
