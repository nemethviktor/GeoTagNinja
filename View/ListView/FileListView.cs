...
namespace GeoTagNinja.View.ListView
{
    ...
    public partial class FileListView : System.Windows.Forms.ListView
    {
        ...
        internal DataTable _objectNames = null;
        ...
        private List<string> _columnIndizes = new List<string>();
        ...
        public void ReadAndApplySetting(string appLanguage, DataTable objectNames)
        {
            Logger.Debug(message: "Starting");
        ...
        public void ReloadFromDEs(DirectoryElementCollection directoryElements)
        {
            ...
            foreach (DirectoryElement item in _directoryElements)
            {
                addListItem(item);
            }
        ...
        public void UpdateItemColour(string itemText, Color color)
        {
            // If the current thread is not the UI thread, InvokeRequired will be true
            if (InvokeRequired)
            {
        ...
        private void FileList_ColumnReordered(object sender, ColumnReorderedEventArgs e)
        {
