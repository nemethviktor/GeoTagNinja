...
internal class ListViewColumnSorter : IComparer
{
                       ...
                       object y)
    {
        ...
        string colName = lvw_FileList.Columns[index: SortColumn]
                                     .Name.Substring(startIndex: HelperVariables.COL_NAME_PREFIX.Length); // no "clh_"
        ...
        try
        {
            ...
            else
            {
                ...
                {
                    string? compareWhat = deX.GetAttributeValueAsString(
                        attribute: attribute, version: deXHighestAttributeVersion,
                        nowSavingExif: false);
                    string? compareToWhat = deY.GetAttributeValueAsString(
